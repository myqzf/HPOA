...
<html>
  <head>
	...
	<!-- addReimburse.js -->
	<script type="text/javascript" src="<%=path%>/js/modreimburse/addReimburse.js"></script>
  	...
  	<table style="width:700px;min-height:80px;" border="1px solid">
 		...
 		<tr>
			<td>
  			...
  			<td>
  				<textarea id="reason" class="reim" maxLength="80"></textarea>
  			</td>
  			<td>
  				<input type="text" id="money" class="reim" maxLength="14">
  			</td>
  		</tr>
...
<!--   		<tr> -->
<!--   			<td><label>部门主管意见：</label><input type="text" value="" id="manOpinioin"/></td> -->
<!--   		</tr> -->
