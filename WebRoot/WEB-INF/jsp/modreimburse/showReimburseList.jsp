...
<html>
  <head>
    ...
    <title>My JSP 'showReimburseList.jsp' starting page</title>
	...
	<!-- showReimburseList.js -->
	<script type="text/javascript" src="<%=path %>/js/modreimburse/showReimburseList.js"></script>
  </head>
  
  <body>
    <div style="margin-bottom:10px;margin-left:10px;margin-top:10px; " id="list">
		<table id="reimburseList"></table>
	</div>
  </body>
</html>
