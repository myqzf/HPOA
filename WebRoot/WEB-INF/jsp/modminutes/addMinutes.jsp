...
<script type="text/javascript" charset="utf-8" src="<%=path %>/js/modminutes/addMinutes.js"></script>
					...
					<form id="minutes_form" action="minutes/addMinutesInfo" method="post" enctype="multipart/form-data" onsubmit="return checkMinutes()">
						...
						<table border="0" cellpadding="5" cellspacing="5" class="tableborder" width="1000" height="354">
							<tr>
								...
								<input class="easyui-datebox" name="meetingdate" id="meetingdate" editable="false"></input></td>
							</tr>
							<tr>
								<td class="listtabletr5" colspan=2><label>地&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;点：</label>
								<input class="easyui-textbox" type="text" name="meetingplace" id="meetingplace" style="width:500px;height:32px"></input></td>
							</tr>
							<tr>
								<td class="listtabletr5" colspan=2><label>主&nbsp;&nbsp;持&nbsp;人：</label>
								<input class="easyui-textbox" type="text" name="meetinghost" id="meetinghost" style="width:500px;height:32px"></input></td>
							</tr>
							<tr>
								<td class="listtabletr5" colspan=2><label>参会人员：</label>
								<input class="easyui-textbox" name="attendees" id="attendees" data-options="multiline:true" style="width:500px;height:60px"></input></td>
							</tr>
							<tr>
								<td class="listtabletr5" ><label>会议主题：</label>
								<input class="easyui-textbox" name="meetingtheme" id="meetingtheme" data-options="multiline:true" style="width:500px;height:60px"></input></td>
							...
							<tr>
								<td class="listtabletr5" colspan=2><label>内容：</label>
								 <textArea id="meetingcontent" name="meetingcontent" type="text/plain" style="width:880px;height:200px;"></textArea>
							...
							<tr>
								...
								<input class="easyui-textbox" name="remark" id="remark" data-options="multiline:true" style="width:800px;height:80px"></input></td>
							</tr>
						</table>
