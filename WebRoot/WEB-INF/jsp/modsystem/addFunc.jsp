...
<html>
  <head>
	...
	<!-- addFunc -->
	<script type="text/javascript" src="<%=path%>/js/modsystem/addFunc.js"></script>
  </head>
    ...
    <table  border="0" width="600px;" style="margin-left:10px;margin-top:10px;"  cellspacing="1" cellpadding="1" align="center">
       ...
       <tr>
        ...
        <tr>
         ...
         <td>是否叶子节点：</td>
         <td><input type="radio" checked="checked" name="isLeaf"   value="1">是</input>&nbsp;&nbsp;<input type="radio"  name="isLeaf"  value="2">否</input></td>
       </tr>
       <tr>
         <td >是否可用：</td>
