...
<html>
  <head>
   <base href="<%=basePath%>">
	...
	<script type="text/javascript" charset="utf-8" src="<%=path %>/js/moddictionary/dictictionztree.js"></script>
  ...
  <body class="mainbody">
	   <p>字典项管理</p>
		<br>
		<a href="/HPOA/dictionary/goAddInDictItem?headId=${headId }">新增一级字典项</a>
      <input type="hidden" name="headId" id="headId" value="${headId }" />
    <div id="messageDiv" style="display:none;">&nbsp;&nbsp;<span id="message"></span></font></div>
	<div>
