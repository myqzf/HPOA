...
<html>
  <head>
	...
	<script type="text/javascript" src="<%=path %>/commonjs/artDialog/plugins/iframeTools.source.js"></script>
	  ...
	  <script type="text/javascript" charset="utf-8" src="<%=path %>/js/modmonthly/viewMonthly.js"></script>
		...
		<div id="main_tablelb" class="main_tablelb">
		  <input type="hidden" name="monthsumid" id="monthsumid" value="${mon.monthsumid }" />
			<table border="0" cellpadding="1" cellspacing="1" class="tableborder" width="800" >
				<tbody>
					<tr>
						...
						<td class="listtabletr3"><label>月份：</label></td> <td align="center"><select name="month" id="month" > <option value="${mon.monthscope }">${mon.monthscope }</option>    </select></td> 
						<td class="listtabletr3"><label>标题：</label></td><td class="listtabletr1"><input type="text" id="title" size="75" value="${mon.monthtitle } " disabled="disabled"></td>
					</tr>
				</tbody>
			</table>
			...
			<div style="margin-top:5px;">
				<textArea id="editor"  style="width:800px;height:375px;">${mon.monthcontent }</textArea>
			</div>
