...
<html>
  <head>
    ...
    <title>My JSP 'receivemanage.jsp' starting page</title>
	...
	<!-- receiveManage.js -->
	<script type="text/javascript" src="<%=path %>/js/modwork/receiveManage.js"></script>
  </head>
  
  <body>
    <div style="margin-bottom:10px;margin-left:10px;margin-top:10px; " id="list">
		<table id="receiveWorkList"></table>
	</div>
  </body>
</html>
